...
const requiredJs = ['localStorage', 'sanitizeSave', 'safeReadSave', 'safeWriteSave', 'getLocalDateKey', 'pets', 'actionHistory', 'personality', 'visualAnchor', 'renderPetState', 'aria-valuenow'];
const requiredCss = ['.status-card', '.room-scene', '.furniture', '.pet', 'data-weather', '.prototype-note', 'data-hungry'];
